...
function alternaController(){"oculta"==localStorage.nota?$(".nota").css("display","none"):$(".cerrarNota").on("click",function(){$(".nota").css("display","none"),localStorage.nota="oculta"}),$("article h2").on("click",function(){$(this).parent().find(".calculos").addClass("activo")}),$(".calculos h3").on("click",function(){$(this).parent().removeClass("activo")})};function continuaController(){"oculta"==localStorage.nota?$(".nota").css("display","none"):$(".cerrarNota").on("click",function(){$(".nota").css("display","none"),localStorage.nota="oculta"}),$("article h2").on("click",function(){$(this).parent().find(".calculos").addClass("activo")}),$(".calculos h3").on("click",function(){$(this).parent().removeClass("activo")})};function iniciaController(){$("article h2").on("click",function(){$(this).parent().find(".calculos").addClass("activo")}),$(".calculos h3").on("click",function(){$(this).parent().removeClass("activo")})};var cosPhi=function(a){if(1==a){var o=parseFloat($("#campo65").val()),l=parseFloat($("#campo66").val()),e=parseFloat($("#campo67").val()),t=$("#resultado28");t.val(o/(l*e))}else if(2==a){var o=parseFloat($("#campo68").val()),r=parseFloat($("#campo69").val()),t=$("#resultado29");t.val(o/r)}else if(3==a){var e=parseFloat($("#campo70").val()),s=parseFloat($("#campo71").val()),r=parseFloat($("#campo72").val()),t=$("#resultado30");t.val(Math.pow(e,2)*s/r)}},cosPhiMonoAlterna=function(){var a=parseFloat($("#cosPhiMonoAlterna_potenciaActiva").val()),o=parseFloat($("#cosPhiMonoAlterna_tension").val()),l=parseFloat($("#cosPhiMonoAlterna_intensidad").val()),e=parseFloat($("#cosPhiMonoAlterna_potenciaAparente").val()),t=parseFloat($("#cosPhiMonoAlterna_resistencia").val()),r=$("#cosPhiMonoAlterna_resultado");a&&o&&l?r.val(a/(o*l)):a&&e?r.val(a/e):l&&e&&t?r.val(Math.pow(l,2)*t/e):r.val("No hay datos suficientes para realizar ningún cálculo")};var intensidadMonoContinua=function(){var a=parseFloat($("#intensidadMonoContinua_tension").val()),n=parseFloat($("#intensidadMonoContinua_resistencia").val()),o=parseFloat($("#intensidadMonoContinua_potencia").val()),t=$("#intensidadMonoContinua_resultado");a&&n?t.val(a/n+"A"):a&&o?t.val(o/a+"A"):n&&o?t.val(Math.sqrt(o/n)+"A"):t.val("No hay datos suficientes para realizar ningún cálculo")},intensidadMonoAlterna=function(){var a=parseFloat($("#intensidadMonoAlterna_potenciaAparente").val()),n=parseFloat($("#intensidadMonoAlterna_tension").val()),o=parseFloat($("#intensidadMonoAlterna_potenciaActiva").val()),t=parseFloat($("#intensidadMonoAlterna_cosPhi").val()),i=parseFloat($("#intensidadMonoAlterna_resistencia").val()),e=$("#intensidadMonoAlterna_resultado");a&&n?e.val(a/n+"A"):n&&o&&t?e.val(o/(n*t)+"A"):n&&t&&i?e.val(n*t/i+"A"):e.val("No hay datos suficientes para realizar ningún cálculo")};var potenciaActivaMonoContinua=function(){var a=parseFloat($("#potenciaActivaMonoContinua_tension").val()),o=parseFloat($("#potenciaActivaMonoContinua_resistencia").val()),n=parseFloat($("#potenciaActivaMonoContinua_intensidad").val()),t=$("#potenciaActivaMonoContinua_resultado");console.log(o),a&&o?t.val(Math.pow(a,2)/o+"W"):o&&n?t.val(Math.pow(n,2)*o+"W"):a&&n?t.val(a*n+"W"):t.val("No hay datos suficientes para realizar ningún cálculo")},potenciaActivaMonoAlterna=function(){var a=parseFloat($("#potenciaActivaMonoAlterna_potenciaAparente").val()),o=parseFloat($("#potenciaActivaMonoAlterna_cosPhi").val()),n=parseFloat($("#potenciaActivaMonoAlterna_tension").val()),t=parseFloat($("#potenciaActivaMonoAlterna_resistencia").val()),i=parseFloat($("#potenciaActivaMonoAlterna_intensidad").val()),e=$("#potenciaActivaMonoAlterna_resultado");a&&o?e.val(a*o+"W"):o&&n&&t?e.val(Math.pow(n*o,2)/t+"W"):o&&n&&i?e.val(n*i*o+"W"):e.val("No hay datos suficientes para realizar ningún cálculo")};var potenciaAparenteMonoAlterna=function(){var a=parseFloat($("#potenciaAparenteMonoAlterna_potenciaActiva").val()),e=parseFloat($("#potenciaAparenteMonoAlterna_cosPhi").val()),n=parseFloat($("#potenciaAparenteMonoAlterna_tension").val()),t=parseFloat($("#potenciaAparenteMonoAlterna_resistencia").val()),o=parseFloat($("#potenciaAparenteMonoAlterna_intensidad").val()),r=$("#potenciaAparenteMonoAlterna_resultado");a&&e?r.val(a/e+"VA"):n&&o?r.val(n*o+"VA"):e&&o&&t?r.val(Math.pow(o,2)*t/e+"VA"):r.val("No hay datos suficientes para realizar ningún cálculo")};var resistenciaMonoContinua=function(){var a=parseFloat($("#resistenciaMonoContinua_potencia").val()),o=parseFloat($("#resistenciaMonoContinua_intensidad").val()),e=parseFloat($("#resistenciaMonoContinua_tension").val()),n=$("#resistenciaMonoContinua_resultado");a&&o?n.val(a/Math.pow(o,2)+"Ω"):a&&e?n.val(Math.pow(e,2)/a+"Ω"):o&&e?n.val(e/o+"Ω"):a&&o&&e?n.val(e/o+"Ω"):n.val("No hay datos suficientes para realizar ningún cálculo")},resistenciaMonoAlterna=function(){var a=parseFloat($("#resistenciaMonoAlterna_tension").val()),o=parseFloat($("#resistenciaMonoAlterna_intensidad").val()),e=parseFloat($("#resistenciaMonoAlterna_cosPhi").val()),n=parseFloat($("#resistenciaMonoAlterna_potenciaActiva").val()),t=parseFloat($("#resistenciaMonoAlterna_potenciaAparente").val()),l=$("#resistenciaMonoAlterna_resultado");a&&o&&e?l.val(a*e/o+"Ω"):a&&e&&n?l.val(Math.pow(a*e,2)/n+"Ω"):o&&e&&t?l.val(t*e/Math.pow(o,2)+"Ω"):l.val("No hay datos suficientes para realizar ningún cálculo")},resistencia=function(a){if(7==a){var o=parseFloat($("#campo79").val()),e=parseFloat($("#campo80").val()),n=$("#resultado34");n.val(o/Math.pow(e*raiz3,2)+"Ω")}else if(8==a){var t=parseFloat($("#campo81").val()),o=parseFloat($("#campo82").val()),n=$("#resultado35");n.val(Math.pow(t,3)/o+"Ω")}else if(9==a){var t=parseFloat($("#campo83").val()),e=parseFloat($("#campo84").val()),n=$("#resultado36");n.val(t/(e*raiz3)+"Ω")}};var tensionMonoContinua=function(){var a=parseFloat($("#tensionMonoContinua_potencia").val()),o=parseFloat($("#tensionMonoContinua_resistencia").val()),n=parseFloat($("#tensionMonoContinua_intensidad").val()),t=$("#tensionMonoContinua_resultado");a&&o?t.val(Math.sqrt(a*o)+"V"):a&&n?t.val(a/n+"V"):o&&n?t.val(o*n+"V"):t.val("No hay datos suficientes para realizar ningún cálculo")},tensionMonoAlterna=function(){var a=parseFloat($("#tensionMonoAlterna_resistencia").val()),o=parseFloat($("#tensionMonoAlterna_intensidad").val()),n=parseFloat($("#tensionMonoAlterna_cosPhi").val()),t=parseFloat($("#tensionMonoAlterna_potenciaActiva").val()),e=parseFloat($("#tensionMonoAlterna_potenciaAparente").val()),l=$("#tensionMonoAlterna_resultado");a&&o&&n?l.val(a*o/n+"V"):o&&n&&t?l.val(t/(o*n)+"V"):o&&e?l.val(e/o+"V"):l.val("No hay datos suficientes para realizar ningún cálculo")},tension=function(a){if(7==a){var o=parseFloat($("#campo73").val()),n=parseFloat($("#campo74").val()),t=$("#resultado31");t.val(Math.sqrt(o/n)+"V")}else if(8==a){var o=parseFloat($("#campo75").val()),e=parseFloat($("#campo76").val()),t=$("#resultado32");t.val(o/(e*raiz3)+"V")}else if(9==a){var e=parseFloat($("#campo77").val()),n=parseFloat($("#campo78").val()),t=$("#resultado33");t.val(e*n*raiz3)}};angular.module("elecalc",["ngRoute"]).config(["$routeProvider",function(o){o.when("/continua",{templateUrl:"app/view/continua.html",controller:continuaController}).when("/alterna",{templateUrl:"app/view/alterna.html",controller:alternaController}).when("/",{templateUrl:"app/view/inicia.html",controller:iniciaController}).when("/inicia",{redirectTo:"/"}).otherwise({templateUrl:"app/view/error.html"})}]),$(document).on("ready",function(){$("html").hasClass("localstorage")?(localStorage.seccion?($("#"+localStorage.seccion).prop("checked",!0),$("#"+localStorage.seccion).parent().addClass("activo")):localStorage.seccion="inicia",window.location="#/"+localStorage.seccion,$("input[name=seccion]").on("click",function(){var o=$(this).val();$("input[name=seccion]").parent().removeClass("activo"),$(this).parent().addClass("activo"),window.location="#/"+o}),$("#abrirConfig,#cerrarConfig").on("click",function(){$("#config,#shadow").toggleClass("activo")}),$("#btnGuardar").on("click",function(){localStorage.seccion=$("input[name=seccion]:checked").val(),$("#cerrarConfig").trigger("click"),window.location="#/"+localStorage.seccion}),$("#shadow").on("click",function(){$("#cerrarConfig").trigger("click")})):$("#navegadorAntiguo").css("display","block")});var raiz3=Math.sqrt(3);